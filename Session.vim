...
map <C-F12> :!ctags -R -I --c++-kinds=+p --fields=+iaS --extra=+q .
onoremap <C-F4> c
nnoremap <C-F4> c
vnoremap <C-F4> c
onoremap <C-Tab> w
...
silent only
cd D:\projects\Mcdonalds
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +2775 RLPlanning_sp_func_scripts.sql
args RLPlanning_sp_func_scripts.sql
edit RLPlanning_sp_func_scripts.sql
...
silent! normal! zE
let s:l = 3115 - ((2 * winheight(0) + 20) / 40)
